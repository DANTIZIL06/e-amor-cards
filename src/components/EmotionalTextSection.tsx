const EmotionalTextSection = () => {
  return (
    <section className="py-8 sm:py-12 px-4 sm:px-6 bg-verde-claro/30">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Texto emocional à esquerda */}
          <div className="text-left animate-fade-in">
            <p className="text-lg sm:text-xl md:text-2xl font-bold text-musgo leading-relaxed max-w-[600px]">
