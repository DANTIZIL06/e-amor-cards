          ...
          <div className="text-center">
            ...
            <div className="mt-10">
              <button
                ...
                className="btn-primary text-xl lg:text-2xl px-10 py-5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-leto font-bold group relative overflow-hidden animate-pulse-gentle"
              >
