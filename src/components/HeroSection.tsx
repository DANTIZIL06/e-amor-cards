          ...
          <div className="text-center lg:text-left space-y-4 animate-fade-in">
            ...
            <div className="space-y-4">
              <button
                ...
                className="btn-primary text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 w-full lg:w-auto min-h-[48px] bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl shadow-[var(--shadow-cta)] hover:shadow-2xl transform hover:scale-105 active:scale-95 transition-all duration-300 font-leto font-bold group relative overflow-hidden animate-pulse"
              >
                <span className="relative z-10">Quero o Meu Declarando Bênçãos</span>
