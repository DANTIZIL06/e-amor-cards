import { Heart, BookOpen, Package, Monitor, Sparkles, Download, Infinity } from "lucide-react";
const features = [{
  icon: Heart,
...
const ProductFeaturesSection = () => {
  return <section className="bg-gradient-to-br from-background via-secondary/5 to-accent/5 py-0 px-[15px]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-leto font-bold text-verde-musgo mb-4 py-[26px]">
        ...
        <div className="relative">
          ...
          <div className="space-y-8 lg:space-y-12">
            ...
            return <div key={index} className={`flex flex-col lg:flex-row items-start gap-6 lg:gap-8 group ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'}`} style={{
              animationDelay: `${index * 150}ms`
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-white to-secondary/50 rounded-2xl flex items-center justify-center shadow-[var(--shadow-card)] group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 border border-secondary/20">
                      <IconComponent className="w-8 h-8 lg:w-10 lg:h-10 text-verde-musgo" strokeWidth={1.5} />
                    </div>
