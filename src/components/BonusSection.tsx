...
const BonusSection = () => {
  return <section className="py-16 px-4 bg-gradient-to-b from-secondary/10 to-background relative overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="relative">
            ...
            <div className="mb-8">
              <img src="/lovable-uploads/c3259da8-734e-400b-8569-930004269b89.png" alt="Todos os bônus especiais inclusos" className="w-full max-w-4xl mx-auto object-contain" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          return <div key={index} className="group bg-gradient-to-br from-white to-secondary/20 p-6 lg:p-8 rounded-2xl shadow-[var(--shadow-card)] hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-secondary/40 hover:border-primary/30 relative overflow-hidden" style={{
