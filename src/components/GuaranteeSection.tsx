...
const GuaranteeSection = () => {
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-verde">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {guarantees.map((guarantee, index) => (
            <div 
              key={index}
              className="bg-white p-3 sm:p-4 md:p-6 rounded-xl text-center shadow-[var(--shadow-card)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1 animate-fade-in"
        ...
        <div className="text-center mt-8 sm:mt-12 animate-fade-in" style={{ animationDelay: '0.5s' }}>
